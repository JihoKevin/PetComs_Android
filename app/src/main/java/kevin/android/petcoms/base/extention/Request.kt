package kevin.android.petcoms.base.extention
 ...
 */
fun <K, V> Map<K, V>.toJsonRequestBody(): RequestBody = toJson().toJsonRequestBody()
...
class JsonObject {
    ...
    fun toJsonRequestBody() = map.toJsonRequestBody()
